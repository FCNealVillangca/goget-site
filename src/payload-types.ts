...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "HomePerformanceBlock".
 */
export interface HomePerformanceBlock {
  title: string;
  features?:
    | {
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "HomePerformanceBlock_select".
 */
export interface HomePerformanceBlockSelect<T extends boolean = true> {
  title?: T;
  features?:
    | T
    | {
